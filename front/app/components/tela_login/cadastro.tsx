...
export default function Cadastro({ }) {
  ...
  return (
    <div className="min-h-screen flex bg-[#e9ecef] from-indigo-600 via-sky-600 to-emerald-500">
      {/* Left column: */}
      ...
      <div className="max-w-sm mx-auto my-auto p-6 border rounded-lg shadow-md bg-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          ...
          <button type="submit" disabled={loading} className="w-full bg-green-600 text-black py-2 rounded hover:bg-green-700 disabled:opacity-60">
